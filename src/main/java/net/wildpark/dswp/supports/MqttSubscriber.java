...
public class MqttSubscriber implements MqttCallback {
    ...
    public void messageArrived(String topic, MqttMessage mm) throws Exception {
        ...
        receveMessages = (topic + ":" + new String(mm.getPayload()) + "\r\n");
        net.wildpark.dswp.entitys.MqttMessage mqttMessage = new net.wildpark.dswp.entitys.MqttMessage();
        mqttMessage.setMessage(topic + new String(mm.getPayload()));
        messageFacade.create(mqttMessage);
